...
export type GetColumnScoresByClassQuery = { __typename?: 'Query', getColumnScoresByClass: Array<{ __typename?: 'ColumnScoreType', id: string, name: string, note?: string | null, type?: ScoreType | null, multiplier: number, scores?: any | null, reference_col?: string | null, examOfClass_id?: string | null }> };
...
export type GetAllExamClassOfClassQueryVariables = Exact<{
  classId: Scalars['String'];
}>;


export type GetAllExamClassOfClassQuery = { __typename?: 'Query', getAllExamClassOfClass: Array<{ __typename?: 'ExamClassType', id: string, dateEnd: any, dateFrom: any, minutes: number, classRoom: { __typename?: 'Class', students?: Array<{ __typename?: 'User', id: string }> | null }, assignmentDone?: Array<{ __typename?: 'AssignmentType', id: string }> | null, exam: { __typename?: 'ExamType', id: string, name: string, tags?: Array<{ __typename?: 'Tag', name: string, color: string }> | null, questions: Array<{ __typename?: 'QuestionType', question: string, id: string }> } }> };
...
export type GetAllExamClassQuery = { __typename?: 'Query', getAllExamClass: Array<{ __typename?: 'ExamClassType', id: string, minutes: number, dateFrom: any, dateEnd: any, scoreFactor: number, isAllowReview: boolean }> };

export type GetMyExamClassQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyExamClassQuery = { __typename?: 'Query', getMyExamClass: Array<{ __typename?: 'ExamClassType', id: string, dateFrom: any, dateEnd: any, minutes: number, isAllowReview: boolean, exam: { __typename?: 'ExamType', name: string, questions: Array<{ __typename?: 'QuestionType', id: string }> } }> };
...
export const GetAllExamClassOfClassDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getAllExamClassOfClass"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"classId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getAllExamClassOfClass"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"classId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"classId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"dateEnd"}},{"kind":"Field","name":{"kind":"Name","value":"dateFrom"}},{"kind":"Field","name":{"kind":"Name","value":"minutes"}},{"kind":"Field","name":{"kind":"Name","value":"classRoom"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"students"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"assignmentDone"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"exam"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"Field","name":{"kind":"Name","value":"questions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"question"}},{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetAllExamClassOfClassQuery, GetAllExamClassOfClassQueryVariables>;
